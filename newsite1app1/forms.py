...
class OrderForm(forms.Form):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['date'].label='Желаемая дата доставки'
        self.fields['date'].help_text='Дата и время доставки предварительно согласуется. Менеджер с вами свяжется.'
...
class RegistrationForm(forms.ModelForm):
    ...
    def __init__ (self, *args, **kwargs):
        ...
        self.fields['email'].help_text='Пожалйста, указывайте реальный адрес электронной почты'
    ...
    def clean(self):
        ...
        if User.objects.filter(email=email).exists():
            raise forms.ValidationError('Данная электронная почта уже используется!')
